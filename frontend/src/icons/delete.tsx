...
export function DeleteIcon({onDelete, contentId}: {onDelete: (contentId:string)=> void; contentId: string}) {
    return <div className="cursor-pointer hover:text-gray-800" onClick={()=> {
       onDelete(contentId);
    }}>
